    ...
    buttons: [
      {
        label: 'Sim',
        onClick: () => {
          api.get('/gestor/delete/'+row._id).then( res => 
...
render() {
      ...
      const columns = [
        {
          dataField: 'tipoGestor',
          text: 'Tipo de Gestor'
        },
        {
          dataField: 'nomeGestor',
          text: 'Nome da Gestor'
        },
        {
          dataField: 'situacao',
        ...
        },
        {
          text: 
            <div className="form-row">
                ...
                <div className="col-sm-3">
                  <Link to={'/createGestor'} className="btn btn-sm btn-outline-success"><Icon.PlusSquareFill/></Link>
                </div> 
            </div>
          ,
          formatter: (cellContent, row) => (
            <div className="form-row">
                <div className="col-sm-3">
                    <Link to={"/editGestor/"+row._id} className="btn btn-sm btn-outline-primary"><Icon.PencilSquare/></Link>
                </div> 
                <div className="col-sm-3">
