      ...
      },
      {
        text: 
            <div>
                ...
                <div className="form-row">
                     <div className="col-sm-3">
                          <Link to={'/createNdc'} className="btn btn-sm btn-outline-success"><Icon.PlusSquareFill/></Link>
                     </div> 
                     <div className="col-sm-3">
        ...
        formatter: (cellContent, row, isSelected, currentDisplayAndSelectedData) => (
          <div className="form-row">
              <div className="col-sm-3">
                  <Link to={"/editNdc/"+row._id} className="btn btn-sm btn-outline-primary"><Icon.PencilSquare/></Link>
              </div> 
              <div className="col-sm-3">
                  <Link to={"/cloneNdc/"+row._id} className="btn btn-sm btn-outline-warning"><Icon.CloudPlus/></Link>
              </div> 
              <div className="col-sm-3">
   ...
   const MySearch = (props) => {
    ...
    return (
        ...
        <div className="responsive bg-dim full-bg-size" style={{styleDiv}}>       
           ...
           {isVisible ? dataPrint.map(item => <PrintNdc data={item} />) : 
              <ToolkitProvider 
                  keyField='_id'
                  data={rowData}
                  columns={ columns }
