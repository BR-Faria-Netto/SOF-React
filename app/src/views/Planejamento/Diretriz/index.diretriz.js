    ...
    buttons: [
      {
        label: 'Sim',
        onClick: () => {
          api.get('/diretriz/delete/'+row._id).then( res => 
        ...
        },
        {
          text: 
            <div className="form-row">
                ...
                <div className="col-sm-3">
                <Link to={'/createDiretriz'} className="btn btn-sm btn-outline-success"><Icon.PlusSquareFill/></Link>
                </div> 
            </div>
          ,
          formatter: (cellContent, row) => (
            <div className="form-row">
                <div className="col-sm-3">
                <Link to={"/editDiretriz/"+row._id} className="btn btn-sm btn-outline-primary"><Icon.PencilSquare/></Link>
                </div> 
                <div className="col-sm-3">
