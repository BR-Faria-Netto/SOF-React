...
export default class Edit extends Component {
  ...
  componentDidMount() {
      axios.get(urlapi+'secretaria/edit/'+this.props.match.params.id)
          .then(response => {
              this.setState({ 
                nomesec : response.data.nomesec,
  ...
  onSubmit(e) {
    ...
    axios.post(urlapi+'secretaria/update/'+this.props.match.params.id, obj)
    .then(res => {
