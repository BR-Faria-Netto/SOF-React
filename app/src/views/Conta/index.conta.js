    ...
    buttons: [
      {
        label: 'Sim',
        onClick: () => {
          api.get('/conta/delete/'+row._id).then( res => 
        ...
        },
        {
          text: 
            <div className="form-row">
                ...
                <div className="col-sm-3">
                  <Link to={'/createConta'} className="btn btn-sm btn-outline-success"><Icon.PlusSquareFill/></Link>
                </div> 
            </div>
          ,
          formatter: (cellContent, row) => (
            <div className="form-row">
                <div className="col-sm-3">
                    <Link to={"/editConta/"+row._id} className="btn btn-sm btn-outline-primary"><Icon.PencilSquare/></Link>
                </div> 
                <div className="col-sm-3">
