    ...
    buttons: [
      {
        label: 'Sim',
        onClick: () => {
          api.get('/responsavel/delete/'+row._id).then( res => 
        ...
        },
        {
          text: 
            <div className="form-row">
                ...
                <div className="col-sm-3">
                  <Link to={'/createResponsavel'} className="btn btn-sm btn-outline-success"><Icon.PlusSquareFill/></Link>
                </div> 
            </div>
          ,
          formatter: (cellContent, row) => (
            <div className="form-row">
                <div className="col-sm-3">
                    <Link to={"/editResponsavel/"+row._id} className="btn btn-sm btn-outline-primary"><Icon.PencilSquare/></Link>
                </div> 
                <div className="col-sm-3">
      ...
      return (
        ...
        <div className="responsive bg-dim full-bg-size" style={{ marginTop:'2px',marginBotton:'2px', marginLeft:'2px', marginRight:'2px', backgroundColor:'#f7f7f7', border: '1px solid #ccc'}}> 
             <div className="form-row" style={{ marginLeft:'1px', marginRight:'1px',  backgroundColor:'#e8e9ea', height:'35px', textalign: 'center' }}>
                  <h5>Relação de Responsável Legal</h5>  
             </div>
